...
life_radio_global = radioChannelCreate [[0.98,0.48,0.06,1], "Global Channel", "%UNIT_NAME", []];
...
//Lockup the dome
private["_dome","_rsb","_fed_loc"];
_fed_loc = getmarkerpos "fed_reserve";
_dome = nearestObject [_fed_loc,"Land_Dome_Big_F"];
_rsb = nearestObject [_fed_loc,"Land_Cargo_House_V3_F"];
