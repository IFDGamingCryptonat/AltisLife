...
compileFinal "
	...
	[[life_atmcash,life_cash,owner player,player],""life_fnc_admininfo_Extended"",_ret,false] spawn life_fnc_MP;
";
publicVariable "fnc_player_query_Extended";
