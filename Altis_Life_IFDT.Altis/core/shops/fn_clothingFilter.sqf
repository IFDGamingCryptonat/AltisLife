...
_clothes = switch (life_clothing_store) do
{
	...
	case "blackbruce": {[_selection] call life_fnc_clothing_blackbruce;};
	case "d12": {[_selection] call life_fnc_clothing_d12;};
	case "press": {[_selection] call life_fnc_clothing_press;};
	case "admin": {[_selection] call life_fnc_clothing_admin;};
};
