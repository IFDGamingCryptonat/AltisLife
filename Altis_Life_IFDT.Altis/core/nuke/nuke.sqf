...
_Cone = "#particlesource" createVehicleLocal getMarkerPos "nukepos";
...
_top = "#particlesource" createVehicleLocal getMarkerPos "nukepos";
...
_top2 = "#particlesource" createVehicleLocal getMarkerPos "nukepos";
...
_smoke = "#particlesource" createVehicleLocal getMarkerPos "nukepos";
...
_Wave = "#particlesource" createVehicleLocal getMarkerPos "nukepos";
...
_light = "#lightpoint" createVehicleLocal [((getMarkerPos "nukepos" select 0)),(getMarkerPos "nukepos" select 1),((getMarkerPos "nukepos" select 2)+500)];
