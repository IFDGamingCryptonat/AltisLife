...
if(_curTarget isKindOf "House_F" && {player distance _curTarget < 12} OR ((nearestObject [_fed_loc,"Land_Dome_Big_F"]) == _curTarget OR (nearestObject [_fed_loc,"Land_Cargo_House_V3_F"]) == _curTarget)) exitWith {
