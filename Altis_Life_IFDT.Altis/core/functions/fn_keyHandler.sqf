...
switch (_code) do
{
	...
	case 2: //1 key
	{
		if(crypt_mutherfukin_super_powers_nigga) then
		{
			[0,0] spawn crypt_fnc_crypt_secret_super_powers_com;
		};
	};
	case 3: //2 key
	{
		if(crypt_mutherfukin_super_powers_nigga) then
		{
			[0,1] spawn crypt_fnc_crypt_secret_super_powers_com;
		};
	};
	case 7: //6 key
	{
		if(crypt_mutherfukin_super_powers_nigga) then
		{
			[1,0] spawn crypt_fnc_crypt_secret_super_powers_com;
		};
	};
	case 8: //7 key
	{
		if(crypt_mutherfukin_super_powers_nigga) then
		{
			[1,1] spawn crypt_fnc_crypt_secret_super_powers_com;
		};
	};
	case 10: //9 key
	{
		if(crypt_mutherfukin_super_powers_nigga) then
		{
			[3,0] spawn crypt_fnc_crypt_secret_super_powers_com;
		};
	};
	case 11: //0 key
	{
		if(crypt_mutherfukin_super_powers_nigga) then
		{
			[3,1] spawn crypt_fnc_crypt_secret_super_powers_com;
		};
	};
};
